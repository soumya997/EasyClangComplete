...
class BaseTestCatkinizer(object):
    ...
    def setUp(self):
        ...
        if not sublime.active_window().project_data():
            ...
            project_file = path.join(
                path.dirname(__file__), "..", "easy_clang_complete.sublime-project"
            )
            import json
    ...
    def test_init(self):
        ...
        self.assertEqual(
            catkinizer._Catkinizer__cmake_file.full_path, test_file.full_path
        )
    ...
    def test_get_ros_distro_path(self):
        ...
        picked = Catkinizer._Catkinizer__get_ros_distro_path(cmake_tests_folder + "/*")
    ...
    def test_get_catkin_ws(self):
        ...
        catkin_ws = path.join(
            path.dirname(__file__), "catkin_tests", "catkin_ws", "devel"
        )
