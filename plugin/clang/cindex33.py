...
class CompletionChunk:
    ...
    def spelling(self):
        ...
        return conf.lib.clang_getCompletionChunkText(self.cs, self.key).spelling.decode(
            "utf8"
        )
...
class TranslationUnit(ClangObject):
    ...
    def from_source(
        ...
        if len(args) > 0:
            largs = (
                arg.encode("utf8") if isinstance(arg, str) else arg for arg in args
            )
...
functionList = [
    ...
    ("clang_getDiagnosticCategoryName", [c_uint], _CXString, _CXString.from_result),
    (
    ...
    ("clang_Type_getSizeOf", [Type], c_ulonglong),
]
